...
local protectGui = (gethui) or (syn and syn["protect_gui"]) -- Protect_Gui, remove this if your exploit doesn't have this function.
...
}); protectGui(UI); UI["Parent"] = Core; -- Protect_Gui, remove this if your exploit doesn't have this function.
